...
const Dropdown = (props) => {
    ...
    // this is another build in hook, it assigns a html/jsx element to a ref
    const divEl = useRef()

    // useEffect depending on waht you pass it
    // will fire once when the component first mount []
...
// this is another component in teh same file, this is a nice resuable UI component that 
